  ...
  <body>
   <div class="container-fluid">
    <form class="mx-auto"  method="post">
      ...
      <button type="submit" class="btn btn-primary   mt-5"   value="Login" name="click"><a href="home1.php">Login</a></button>
      <button class="signup  mt-5"><a href="sign.php">Sign in</a></button>
    </form>
